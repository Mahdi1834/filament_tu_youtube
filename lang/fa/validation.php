...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'status' => 'وضعیت',
        'new_categories' => 'دسته بندی',
        'tags' => 'تگ',
        'tags.*' => 'تگ',
        'categories' => 'دسته بندی',
        'categories.*' => 'دسته بندی',
        'teachers' => 'مدرس یا سخنران',
        'start_date' => 'تاریخ شروع',
        'start_time' => 'زمان شروع',
        'end_date' => 'تاریخ پایان',
        'end_time' => 'زمان پایان',

        'education_level_id' => 'سطح تحصیلات',
        "province_id" => "استان",
        'city_id' => 'شهر',
        'title_edu' => 'عنوان محل تحصیل',
        'field' => 'رشته',
        'cellphone'=>'شماره همراه',
        'method'=>' روش اشنایی',
        'suggestedDuration'=>'مدت زمان پیشنهادی',
        'skills'=>'مهارت ها',
        'skills.*'=>'مهارت ',
        'budget_max'=>'بیشترین بودجه',
        'budget_min'=>'کمترین بودجه ',
        'industries'=>'صنعت ',
        'industries.*'=>' صنعت ',
        'parent_id' => 'شناسه والد',
        'subject_id'=>"موضوع",
        'activity_type_id'=>"نوع فعالیت",
        'Founded_date'=>"تاریخ تاسیس",
        'section_id'=>'دسته بندی',
        'organization_level_id'=> 'رده سازمانی',
        'occupation_id'=> 'شغل',
        'industry_id'=> 'صنعت',
        'presence_id'=> 'نوع حضور',
        "menu-copy-url"=> "کپی آدرس",
        "content_fa"=> "محتوای فارسی",
        "content_ar"=> "محتوای عربی",
        "sureh_id"=> "شناسه سوره",
        "ayahe_id"=> "شناسه آیه",
