...
class UserImporter extends Importer
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ImportColumn::make('email')->requiredMapping()->rules(['required', 'max:255', 'email']),
            ImportColumn::make('password')->requiredMapping()->rules(['required', 'max:255'])->castStateUsing(function (string $state) {
